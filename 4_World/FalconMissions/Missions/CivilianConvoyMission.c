class CivilianConvoyMission extends FM_MissionBase
{
	ref array<string> zombiesTypes = new ref array<string>();	
	ref array<string> wrecksTypes = new ref array<string>();	
	
	void CivilianConvoyMission(int missionId, vector missionCenter, int missionRadius)
	{
		...
		missionName = "Destroyed Civilian Convoy";
		missionLifespan = 3600;
		maxMissionItems = 5;
		
		wrecksTypes.Insert("Land_Wreck_Lada_Green_Mission");
		wrecksTypes.Insert("Land_Wreck_Ikarus_Mission");
		zombiesTypes.Insert("ZmbM_CitizenASkinny_Brown");
	}
